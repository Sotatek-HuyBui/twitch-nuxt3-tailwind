<template>
    <div>
        <DirectorySectionLive :key="`DirectorySectionLive-${forceRenderlocale}`" :header="$t('Directory.Esports.desc1')"
            :items="lives" :directorySection="directorySection" />
        <DirectorySectionLive header="Valorant" :items="lives" :directorySection="directorySection" />
        <DirectorySectionLive header="CS:GO" :items="lives" :directorySection="directorySection" />
    </div>
</template>
