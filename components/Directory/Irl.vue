<template>
    <div>
        <DirectorySectionRecommendations :key="`DirectorySectionRecommendations-${forceRenderlocale}`"
            :header="$t('Directory.IRL.desc1')" :items="categories" />
        <DirectorySectionLive :key="`DirectorySectionLive-${forceRenderlocale}`" :header="$t('Directory.IRL.desc2')"
            :items="lives" :directorySection="directorySection" />
        <DirectorySectionLive :key="`DirectorySectionLive-${forceRenderlocale}`" header="ASMR" :items="lives"
            :directorySection="directorySection" />
        <DirectorySectionLive :key="`DirectorySectionLive-${forceRenderlocale}`" :header="$t('Directory.IRL.desc3')"
            :items="lives" :directorySection="directorySection" />
    </div>
</template>
