<template>
    ...
    >
        <input
            type="search"
            id="search-dropdown"
            class="block w-full px-2 z-20 text-[8px] sm:text-[14px] border border-slate-400 dark:border-slate-800 dark:focus:border-customPrimary-0 rounded-l-md focus:border-4 focus:outline-none focus:border-customPrimary-1"
            placeholder="Search"
            v-model="search"
