                    ...
                    >
                        ...
                        <div class="flex items-center">
                            ...
                            <UTooltip text="Share" class="p-2 rounded-md">
                                <UButton
                                    type="submit"
                                    class="bg-lightBackgroundSlot outline-none border-0 items-center justify-center dark:text-white text-black dark:bg-slate-900 dark:hover:bg-slate-800 hover:bg-slate-200"
