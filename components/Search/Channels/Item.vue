<template>
    <div class="flex mb-8 w-[100%]">
        <img
            :src="item.avatar"
            class="w-[50px] h-[50px] sm:w-[120px] sm:h-[120px] rounded-full mr-4 sm:mr-6 border-2 cursor-pointer"
        />
        <div class="w-[100%] sm:w-[50%] overflow-hidden">
            ...
            <p class="text-[10px] sm:text-sm text-gray-500 mb-2 sm:mb-4">
                {{ formatNumber(item.followers) }} follwers
            </p>
            <p class="text-[8px] sm:text-sm text-gray-500 mb-2 sm:mb-6">
                {{ item.description }}
            </p>
            <div v-if="item.latestVideos.length > 0" class="mb-6">
                <p class="text-[10px] sm:text-sm text-gray-700 mb-2">
                ...
                <div class="flex">
                    ...
                    >
                        ...
                        <div
                            class="border-[1px] border-gray-300 border-t-0 py-1 rounded-bl-md rounded-br-md"
                        >
            ...
            <div v-if="item?.nextStream?.time">
                ...
                <div class="flex">
                    <div
                        class="border-[1px] border-gray-200 rounded-md p-2 min-w-[300px]"
                    >
